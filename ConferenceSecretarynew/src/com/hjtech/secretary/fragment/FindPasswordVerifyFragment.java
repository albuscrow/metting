...
public class FindPasswordVerifyFragment extends BaseFragment {
	...
	private ViewGroup initUI(LayoutInflater inflater) {
		rootView = (ViewGroup) inflater.inflate(
				R.layout.fragment_findpassword_verify, null);
				...
				new GetDataAnsycTask().setOnDataAnsyTaskListener(
						new OnDataAnsyTaskListener() {
							...
							public void onPostExecute(Object result) {
								...
								int resultCode = ((MTSimpleResult) result)
										.getResult();
								switch (resultCode) {
								case -1:
		...
		gv(R.id.register_complete_button).setOnClickListener(
				new OnClickListener() {
					@Override
					public void onClick(View v) {
