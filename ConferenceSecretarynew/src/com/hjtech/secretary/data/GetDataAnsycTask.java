...
public class GetDataAnsycTask extends AsyncTask<Object, Void, Object> {
	...
	protected Object doInBackground(Object... params) {
		...
		if (AppConfig.isNetConnect()) {
			...
			case VALIDATION:
				type = new TypeToken<MTSimpleResult>(){}.getType();
				result = DataProvider.validation(type,(String)params[1],(String) params[2],(String) params[3]);
				break;
			case REGISTER:
...
//				break;
	...
	public void Validation(String phone, String vCode,String type){
		this.execute(JsonTarget.VALIDATION, phone, vCode, type);
	}
